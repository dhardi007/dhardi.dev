...
export const skills: Skill[] = [
  ...
  { name: 'OpenCode', icon: 'IconVSCode', color: '#6C5CE7', category: 'AI', description: 'Asistente de código con memoria persistente (Engram), Claude, OpenRouter, Antigravity y herramientas MCP (n8n, archivos, terminal). Mejor que Claude Desktop.', tags: ['AI', 'Assistant', 'Engram', 'MCP', 'Claude', 'OpenRouter'] },
];
